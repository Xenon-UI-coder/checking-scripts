...
text2.Text = "To make it work set experience language to vietnam in pause menu (Esc), made by ??? :D"
...
TextButton.Position = UDim2.new(0.875457883, 0, 0, 0)
...
Frame.Position = UDim2.new(0.506125569, 0, 0.269968063, 0)
Frame.Size = UDim2.new(0, 555, 0, 309)
Frame.Visible = false
...
TextLabel.Position = UDim2.new(0.0126126129, 0, 0, 0)
TextLabel.Size = UDim2.new(0, 222, 0, 55)
TextLabel.Font = Enum.Font.SourceSans
TextLabel.Text = " FakeVerifiedChat V2.5"
...
TextButton_2.Position = UDim2.new(0.906306326, 0, 0.0161812305, 0)
TextButton_2.Size = UDim2.new(0, 46, 0, 39)
...
message.Position = UDim2.new(0.0360360369, 0, 0.203883499, 0)
message.Size = UDim2.new(0, 320, 0, 199)
...
TextButton_3.BackgroundColor3 = Color3.fromRGB(0, 255, 85)
TextButton_3.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextButton_3.BorderSizePixel = 0
TextButton_3.Position = UDim2.new(0.64864862, 0, 0.242718443, 0)
TextButton_3.Size = UDim2.new(0, 173, 0, 38)
TextButton_3.Font = Enum.Font.SourceSans
TextButton_3.Text = "Send"
...
TextButton_4.BackgroundColor3 = Color3.fromRGB(0, 255, 85)
TextButton_4.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextButton_4.BorderSizePixel = 0
TextButton_4.Position = UDim2.new(0.64864862, 0, 0.436893195, 0)
TextButton_4.Size = UDim2.new(0, 173, 0, 38)
...
TextButton_5.BackgroundColor3 = Color3.fromRGB(0, 255, 85)
TextButton_5.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextButton_5.BorderSizePixel = 0
TextButton_5.Position = UDim2.new(0.64864862, 0, 0.631067932, 0)
TextButton_5.Size = UDim2.new(0, 173, 0, 38)
...
TextButton_6.Position = UDim2.new(0.823423445, 0, 0.0161812305, 0)
TextButton_6.Size = UDim2.new(0, 46, 0, 39)
...
Test.Position = UDim2.new(0.376722813, 0, 0.0894568712, 0)
Test.Size = UDim2.new(0, 54, 0, 50)
...
lol.Size = UDim2.new(0, 66, 0, 64)
lol.Visible = false
lol.Image = "rbxassetid://15719832182"

-- Scripts:

local function CBTTEZ_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(CBTTEZ_fake_script)()
...
coroutine.wrap(RHLUFFH_fake_script)()
local function XRGRJFK_fake_script() -- TextButton_4.LocalScript 
...
coroutine.wrap(XRGRJFK_fake_script)()
local function SLBYVPV_fake_script() -- TextButton_5.LocalScript 
	local script = Instance.new('LocalScript', TextButton_5)

	script.Parent.MouseButton1Click:Connect(function()
		local msg = script.Parent.Parent.message
		if msg then
			msg.Text = ""
		end
	end)
end
coroutine.wrap(SLBYVPV_fake_script)()
local function GZANONI_fake_script() -- TextButton_6.LocalScript 
	local script = Instance.new('LocalScript', TextButton_6)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Visible = false
		script.Parent.Parent.Parent.Test.lol.Visible = true
	end)
end
coroutine.wrap(GZANONI_fake_script)()
local function KOLO_fake_script() -- lol.UIDrag 
...
coroutine.wrap(KOLO_fake_script)()
local function CBUAI_fake_script() -- lol.LocalScript 
	local script = Instance.new('LocalScript', lol)
...
coroutine.wrap(CBUAI_fake_script)()