...
gui.Name = "ICY Gui - Client Side Script"
...
Frame.BorderColor3 = Color3.fromRGB(0, 0, 255) -- Blue
...
ImageLabel.Image = "rbxassetid://18424901943"
...
TextButton.BorderColor3 = Color3.fromRGB(0, 0, 255) -- Blue
...
for Get,Players in ipairs(game.Players:GetPlayers()) do
			...
			for Get,Workspace in ipairs(game.Workspace:GetChildren()) do
				...
				if (Workspace.Name == Players.Name) then
					...
					ParticleEmitter.Texture = ("rbxassetid://18424901943");
...
TextButton.BackgroundColor3 = Color3.new(0, 0, 0)
TextButton.BorderColor3 = Color3.fromRGB(0, 0, 2551) -- Blue
TextButton.BorderSizePixel = 2
TextButton.BackgroundTransparency = 0.66
TextButton.Text = "666"
TextButton.TextSize = 23
...
local jumpstyle		= Instance.new("Sound")
		...
		jumpstyle.Looped		= true
		jumpstyle.Pitch      = 0.7
		jumpstyle.Volume		= 100000000000000000000000
end)
...
for Get,Players in ipairs(game.Players:GetPlayers()) do
		...
		for i,v in pairs(b) do
			...
			a["Skybox"..v]="rbxassetid://18424901943 "
		...
		s.SoundId = "http://www.roblox.com/asset/?id=1839246711" --Put the id into there.
		...
		s.SoundId = "http://www.roblox.com/asset/?id=1839246711" --Put the idi into there.
		...
		for i,v in pairs(game.Players:GetChildren()) do
			isis = Instance.new("Message",workspace)
			isis.Text = "OH FUCK, JUMPSTYLE SO GOOD!"
			wait(1)
			isis:Destroy()
			bomb = Instance.new("Explosion")
			bomb.Parent = v.Character.Torso
...
TextButton.MouseButton1Click:Connect(function()
		...
		while true do
			...
			msg.Text = "--. . - .. .. -. --. / .... .- -.-. -.- . -.. / -... -.-- / .. -.-. . .---- ....- -.... --... ---.. ..--- / .-.. --- .-.. / ... - ..- .--. .. -.. / -. .. --. --. . .-. / --. .- -- ."
			wait(1.5)
			msg.Text = "TEAM ICY HACKED YOUR GAME!!!"
			wait(1.5)
		end
end)
...
TextLabel.BorderColor3 = Color3.new(0, 0, 255)
TextLabel.BorderSizePixel = 0
TextLabel.Text = "Cerdits To : ??? (ICY.Hub Discord)"
...
TextLabel.BorderColor3 = Color3.new(0, 0, 255)
TextLabel.BorderSizePixel = 0
TextLabel.Text = "Made By ice146782 "
