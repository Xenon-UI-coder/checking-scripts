...
local AOX = Instance.new("ScreenGui") -- The actual GUI
...
local Title = Instance.new("TextLabel") -- Actual title of GUI, AOX
 
-- Properties
 
AOX.Name = "AOX"
AOX.Parent = game.Players.LocalPlayer.PlayerGui
 
SideFrame.Name = "SideFrame"
SideFrame.Parent = AOX
