...
Title = "LOADED AOC Scripts V2 "; -- the title 
...
local Window = Library.CreateLib("AOC Scripts V0.1", "GrapeTheme")
...
Section2:NewSlider("Speed", "Set you speed", 500, 16, function(s) -- 500 (MaxValue) | 16 (MinValue)
...
local Section10 = Tab10:NewSection("Keyboard | mobile")
