...
local Window = Rayfield:CreateWindow({
   Name = "Secret hub | Dead Rails",
   Icon = 16730731897, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "Loading....",
   LoadingSubtitle = "No credits: Stay Anonymous",
   ...
   ConfigurationSaving = {
      Enabled = true,
      FolderName = DeadRails, -- Create a custom folder for your hub/game
      FileName = "Secret Hub"
   },
})
