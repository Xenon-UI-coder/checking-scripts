...
setclipboard("https://discord.gg/345NFC9mQm")
wait(1.5)
...
-- เพิ่ม UICorner ให้ Frame - IN BETA MIGHT REMOVED
local UICorner = Instance.new("UICorner")
UICorner.CornerRadius = UDim.new(0, 15) -- ปรับค่าตามที่ต้องการ
UICorner.Parent = Frame

-- แทนที่พื้นหลังของ Frame ด้วย ImageLabel - IN BETA MIGHT REMOVED
local ImageLabel = Instance.new("ImageLabel")
ImageLabel.Parent = Frame
ImageLabel.Size = UDim2.new(1, 0, 1, 0) -- ทำให้ ImageLabel ครอบคลุมทั้ง Frame
ImageLabel.Position = UDim2.new(0, 0, 0, 0)
ImageLabel.BackgroundTransparency = 0.6 -- ทำให้พื้นหลังโปร่งใส
ImageLabel.Image = "rbxassetid://18424901943" -- ใส่ ID ของรูปภาพที่ต้องการใช้เป็นพื้นหลัง

-- เพิ่ม UICorner ให้ ImageLabel เพื่อให้มีขอบโค้ง - IN BETA MIGHT REMOVED
local UICorner = Instance.new("UICorner")
UICorner.CornerRadius = UDim.new(0, 15) -- ปรับค่าตามที่ต้องการ
UICorner.Parent = ImageLabel

-- เพิ่ม UICorner ให้ ImageLabel - IN BETA MIGHT REMOVED
local UICorner = Instance.new("UICorner")
UICorner.CornerRadius = UDim.new(0, 15) -- ปรับค่าตามที่ต้องการ
UICorner.Parent = ImageLabel
...
Frame.BackgroundTransparency = 0.6 -- ทำให้พื้นหลังโปร่งใส - IN BETA MIGHT REMOVED
...
TextButton_11.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_12.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_14.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_15.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_16.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_17.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_18.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_19.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_20.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_21.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_22.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_23.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_24.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_25.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_26.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_27.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_27.Text = "N1NJ4 face all"
...
TextButton_28.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_29.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_29.Text = "OldRobloxSky"
...
TextButton_30.BorderColor3 = Color3.fromRGB(0, 0, 255)
...
TextButton_30.Text = "OldRobloxSky2"
	...
	function click()
		local function exPro(root)
			for _, v in pairs(root:GetChildren()) do
				if v:IsA("Decal") and v.Texture ~= "http://www.roblox.com/asset/?id=18424901943" then
					v.Parent = nil
				elseif v:IsA("BasePart") then
					...
					One.Texture = "http://www.roblox.com/asset/?id=18424901943"
					Two.Texture = "http://www.roblox.com/asset/?id=18424901943"
					Three.Texture = "http://www.roblox.com/asset/?id=18424901943"
					Four.Texture = "http://www.roblox.com/asset/?id=18424901943"
					Five.Texture = "http://www.roblox.com/asset/?id=18424901943"
					Six.Texture = "http://www.roblox.com/asset/?id=18424901943"
					One.Face = "Front"
					Two.Face = "Back"
					Three.Face = "Right"
					Four.Face = "Left"
...
local function CDSNOXH_fake_script() -- TextButton_2.Script 
	...
	function click()
		...
		s.SkyboxBk = "http://www.roblox.com/asset/?id=18424901943"
		s.SkyboxDn = "http://www.roblox.com/asset/?id=18424901943"
		s.SkyboxFt = "http://www.roblox.com/asset/?id=18424901943"
		s.SkyboxLf = "http://www.roblox.com/asset/?id=18424901943"
		s.SkyboxRt = "http://www.roblox.com/asset/?id=18424901943"
		s.SkyboxUp = "http://www.roblox.com/asset/?id=18424901943"
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		function xds(dd)
			for i,v in next,dd:children''do
				...
				local dec = 'http://www.roblox.com/asset/?id=18424901943';
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		sky = coroutine.create(function()
			while wait(0.3) do
				...
				s.SkyboxBk,s.SkyboxDn,s.SkyboxFt,s.SkyboxLf,s.SkyboxRt,s.SkyboxUp = "rbxassetid://18424901943","rbxassetid://201208408","rbxassetid://201208408","rbxassetid://201208408","rbxassetid://201208408","rbxassetid://201208408"
		...
		msg = coroutine.create(function()
			while wait(0.4) do
				...
				msg.Text = "N1NJ4 HACKED YOUR GAME"
				wait(0.4)
				msg:Destroy()
			end
		end) 
...
local function SEHG_fake_script() -- TextButton_6.Script 
	...
	script.Parent.MouseButton1Down:connect(function()
		for i, players in pairs(game.Players:GetChildren()) do
			players:Kick("TEAM N1NJA NOT SKID YOU DUMB ASS")
		end
	end)
		...
		for i,v in pairs(game.Players:GetPlayers()) do
			if v.Name ~= me and not v.PlayerGui:FindFirstChild("Screamer") and v:FindFirstChild("PlayerGui") then
				spawn(function()
					...
					newimage.Image = "http://www.roblox.com/asset/?id=116935924098111"
...
local function NCFMR_fake_script() -- TextButton_11.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		for i, v in pairs(game.Players:GetChildren()) do
			...
			emit.Texture = "http://www.roblox.com/asset/?id=18424901943"
	...
	script.Parent.MouseButton1Click:connect(function()
		...
		for i = 1, 10 do
			for i, v in pairs(game:GetService("Players"):GetChildren()) do
				...
				emit.Parent = v.Character.Head
				emit.Texture = "http://www.roblox.com/asset/?id=18424901943" -- 18424901943
				emit.VelocitySpread = 100000
		...
		Sound0.Looped = true
		Sound0.Playing = true
		Sound0.SoundId = "rbxassetid://1839246711"
	end)
end
		...
		function exPro(root)
			for _, v in pairs(root:GetChildren()) do
				...
				elseif v:IsA("BasePart") then
					...
					Three.Texture = "http://www.roblox.com/asset/?id=18424901943"
					Four.Texture = "http://www.roblox.com/asset/?id=18424901943"
					Five.Texture = "http://www.roblox.com/as set/?id=18424901943"
					Six.Texture = "http://www.roblox.com/asset/?id=18424901943"
					One.Face = "Front"
					Two.Face = "Back"
					Three.Face = "Right"
...
local function BCUFIQU_fake_script() -- TextButton_19.Script 
	...
	function click()
		...
		s.SkyboxBk = "rbxassetid://18424901943"
		s.SkyboxDn = "rbxassetid://18424901943"
		s.SkyboxFt = "rbxassetid://18424901943"
		s.SkyboxLf = "rbxassetid://18424901943"
		s.SkyboxRt = "rbxassetid://18424901943"
		s.SkyboxUp = "rbxassetid://18424901943"
		game.Lighting.TimeOfDay = 12
	end
...
local function PCXMSM_fake_script() -- TextButton_21.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
		game:GetService('TeleportService'):Teleport( 7216605676, game.Players.LocalPlayer)
	end)
end
	...
	function click()
		for i,v in pairs(game.Players:GetChildren()) do
			if v.Character:FindFirstChild("Head") then
				...
				text1.Image = "http://www.roblox.com/asset/?id=18424901943"
